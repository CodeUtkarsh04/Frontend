...
const UserDashNavbar = () => {
  ...
  // ✅ Detect if currently in helper view
  useEffect(() => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 fixed w-full top-0 left-0 z-2000 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <ul className="hidden md:flex space-x-10 font-medium">
          <li>
            <NavLink to="/user/dashboard" end className={linkClasses}>
              Dashboard
            </NavLink>
          </li>
          <li>
            <NavLink to="/user/tasks" className={linkClasses}>
              My Tasks
            </NavLink>
          </li>
          <li>
